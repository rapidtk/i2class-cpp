...
I2CLASS.PGM: I2CLASSCPP.MODULE I2CLASS.SRVPGM
	...
	@echo "CRTPGM PGM($(OBJLIB)/I2CLASSCPP) MODULE($(OBJLIB)/I2CLASSCPP) BNDSRVPGM($(OBJLIB)/I2CLASS) ACTGRP(*NEW)"
	@system "CRTPGM PGM($(OBJLIB)/I2CLASSCPP) MODULE($(OBJLIB)/I2CLASSCPP) BNDSRVPGM($(OBJLIB)/I2CLASS) ACTGRP(*NEW)"
