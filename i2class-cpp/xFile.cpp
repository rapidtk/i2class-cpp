...
Xfile::Xfile(const AS400 &as400, char *sFileName)
{
...
/*
Xfile::Xfile(AS400 &as400, char *sFileName, Xrecord &format)
{
	Xfile(as400, sFileName);
	setRecord(format);
}
*/

void Xfile::setRecord(Xrecord &format)
{
	record = &format;
}
...
////////////////////////////////////////////////////////////////////////////////
// Print file stuff
void XrecordPrint::edit(char *buf, const _ConvertDecimal &n, const char *edtWrd)
{
...
void XrecordPrint::printChar(const char *str, int edtLen, int col)
{
	setMaxColumn(col);
...
void XrecordPrint::print(const char *str, int col)
	{ printChar(str, strlen(str), col); }

void XrecordPrint::printl(const FixedTemp &f, int col)
{
	if (col<=0)
		col=column;
	print(f, col+f.len()-1);
}
void XrecordPrint::printl(const char *str, int col)
{
...
void XrecordPrint::print(int i, int col, const char *edtWrd)
{
	Zoned<9,0> dec(i); // Convert i to _ConvertDecimal
   print(dec, col, edtWrd);
}
void XrecordPrint::print(const _ConvertDecimal &n, int col, const char *edtWrd)
{
	setMaxColumn(col);
...
void XrecordPrint::printl(const _ConvertDecimal &n, int col, const char *edtWrd)
{
	if (col<=0)
		col=column;
...
void XrecordPrint::print(int i, int col, char edtCde, char fillChar)
{
	Zoned<9,0> dec(i); // Convert i to _ConvertDecimal
   print(dec, col, edtCde, fillChar);
}
void XrecordPrint::print(const _ConvertDecimal &n, int col, char edtCde, char fillChar)
{
...
//void XrecordPrint::printl(const ZonedTemp &n, int col, char edtCde, char fillChar)
void XrecordPrint::printl(const _ConvertDecimal &n, int col, char edtCde, char fillChar)
{
	if (col<=0)
		col=column;
